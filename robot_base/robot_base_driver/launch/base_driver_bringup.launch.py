...
def generate_launch_description():
    bringup_dir = get_package_share_directory('robot_base_driver')
    launch_dir = os.path.join(bringup_dir, 'launch')
    ekf_config = Path(get_package_share_directory('robot_base_driver'), 'config', 'ekf.yaml')
    imu_config = Path(get_package_share_directory('robot_base_driver'), 'config', 'imu.yaml')
